...
def mengetik(s):
    for c in s + '\n':
        ...
        sys.stdout.flush()
        time.sleep(7. / 100)
mengetik("Loading dulu bang sebentar :v")
mengetik("--------------------------------------->(100%)")
mengetik("Loading Berhasil Welcome to tools sc deface")
os.system("clear")
mengetik("╔═══╗╔═══╗╔═╗╔═╗╔══╗─╔╗─╔╗╔═══╗╔════╗╔═══╗╔═╗─╔╗")
mengetik("║╔═╗║║╔══╝║║╚╝║║║╔╗║─║║─║║║╔═╗║║╔╗╔╗║║╔═╗║║║╚╗║║")
mengetik("║╚═╝║║╚══╗║╔╗╔╗║║╚╝╚╗║║─║║║║─║║╚╝║║╚╝║║─║║║╔╗╚╝║")
...
mengetik("╚═══╝╚═══╝╚╝───╚╝─╚╝╚═══╝╚═══╝")
mengetik("{÷}============================================={÷}")
mengetik("{÷}          Pembuatan Script Deface            {÷}")
mengetik("{÷}============================================={÷}")
mengetik("{÷} author : MR.15XCYBER                        {÷}")
mengetik("{÷} kontak me : +63 838-6682-5454               {÷}")
mengetik("{÷} Team : CYBER JATENG X-PLOIT TEAM            {÷}")
mengetik("{÷} Github : https://github.com/MR15XCYBEERRR   {÷}")
mengetik("{÷}============================================={÷}")

mengetik( "Silahkan dicoba :)")

title = input("Masukkan judul : ")
nick = input("Hacked by : ")
team = input("Nama team : ")
img = input("Link gambar : ")
mengetik("Dibawah ini pesan halaman awal ya")
pesan = input("Pesan 1 : ")
pesan2 = input("Pesan 2 : ")
pesan3 = input("Pesan 3 : ")
pesan4 = input("Pesan 4 : ")
mengetik("Yang ini pesan untuk adminnya")
kata = input("Kata 1 : ")
kata2 = input("Kata 2 : ")
kata3 = input("Kata 3 : ")
greetz = input("Thanks to : ")
mengetik("Nama file (contoh:kntl.html")
...
file.write(l2)
print
mengetik("Script anda berhasil dibuat dengan nama:v , namafile")
print
mengetik("Terima Kasih telah mencoba karya saya :)")
